...
class BinarySearchTree:
    ...
    # 0(logN) BUT if the tree is balances (left subtree contains app. same amount of item then right subtree)
    def insert_node(self, data, node):
        ...
        # we have to got to the right subtree
        else:
            if node.rightChild:
...
print('Max value: %d ' % bst.get_max(bst.root))
print('Min value: %d ' % bst.get_min(bst.root))
